...
class Scene @Inject constructor(private val sceneRegionBuilder: SceneRegionBuilder) {
    var radius: Int = 1
    ...
    private val hoveredEntity: ObjectProperty<SceneTile?> = SimpleObjectProperty(null)
    private val selectedEntity: ObjectProperty<Any?> = SimpleObjectProperty(null)
